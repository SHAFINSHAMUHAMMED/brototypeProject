...
function ClientTable() {
    ...
    useEffect(() => {
        adminAxios
            ...
            .then((response) => {
                console.log(response.data.result,'asdfghjkl');
        ...
        <div className="">
            <div className="m-5 ms-3">
                <nav className="navbar bg-light">
                    ...
                    <button onClick={()=>navigate('/admin/addNewUser')} className="btn btn-dark" type="submit">
                                Add New User
                            </button>
                        <form className="d-flex flex-fill ps-5" role="search">
                            <input
